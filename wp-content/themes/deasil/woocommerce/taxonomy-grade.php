...
$icon_id = get_term_meta ( $term_id, 'grade-icon-id', true );
if($icon_id == ''){
	$icon_id = 'icon-level-1';
}
$image_id = get_term_meta ( $term_id, 'grade-image-id', true );
...
<?php endif;?>
		<div class="page-img-txt container">
			<div class="row">
				<div class="col-sm-3">
					<i class="grade-icon <?php echo esc_attr($icon_id);?>"></i>
				</div>
				<div class="col-sm-8">
