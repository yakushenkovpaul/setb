...
function customizer_library_get_all_fonts() {
	$heading       = array( 2 => array( 'label' =>  __( 'Disable', 'deasil' ) ) );
	 ...
	 */
	//return apply_filters( 'customizer_library_all_fonts', array_merge( $heading2, $google_fonts ) );
	return apply_filters( 'customizer_library_all_fonts', array_merge( $heading, $google_fonts ) );
}
endif;
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'deasil' ),
		'cyrillic'     => __( 'Cyrillic', 'deasil' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'deasil' ),
		'devanagari'   => __( 'Devanagari', 'deasil' ),
		'greek'        => __( 'Greek', 'deasil' ),
		'greek-ext'    => __( 'Greek Extended', 'deasil' ),
		'khmer'        => __( 'Khmer', 'deasil' ),
		'latin'        => __( 'Latin', 'deasil' ),
		'latin-ext'    => __( 'Latin Extended', 'deasil' ),
		'vietnamese'   => __( 'Vietnamese', 'deasil' ),
		);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'deasil' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
			),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'deasil' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
			),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'deasil' ),
